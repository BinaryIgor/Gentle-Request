...
public final class HttpRequests implements Requests {
	...
	@Override
	public Response methodResponse(String method, String url, byte[] body, Header... headers)
			throws Exception {
	...
	private Response response(String url, String method, byte[] body, Header... headers)
			throws Exception {
